<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Tambah Data Topik Forum</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="wrapper wrapper-content  animated fadeInRight">
                   ...
                   <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Manegemen Tambah Data Topik Forum  <small></small></h5>
                            ...
                            <div class="col-md-12">
                                <div class="ibox float-e-margins">
                                        ...
                                        <div class="form-group">
                                            <label>Judul Topik Forum</label>
                                            <input type="text" class="form-control" placeholder="Isi Dengan Judul Topik Forum" name="name" required>
                                        </div>
                                        <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="row">
                                           <div class="col-md-12">
                                               <div class="panel panel-primary">
                                               <div class="panel-heading"><span class="fa fa-picture-o"></span> Upload Media</div>
                                               <div class="panel-body">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
