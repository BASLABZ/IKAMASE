                            ...
                            <div class="col-md-12">
                                <div class="ibox float-e-margins">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo form_open( 'login/jabatan/simpan',[ 'class'=> 'role', 'id' => 'validform']) ?>
                                        <div class="form-group">
                                            <label>Jabatan</label>
                                            <input type="text" class="form-control" placeholder="Isi Dengan Nama Jabatan" name="jabatan" required>
                                        </div>
                                        <div class="form-group">
