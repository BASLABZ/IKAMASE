                ...
                <div class="wrapper wrapper-content  animated fadeInRight">
                   ...
                   <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Manegemen Tambah Data Program Kerja  <small></small></h5>
                            ...
                            <div class="col-md-12">
                                <div class="ibox float-e-margins">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Isi Dengan Judul Program Kerja" name="name" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Desikripsi Program Kerja</label>
